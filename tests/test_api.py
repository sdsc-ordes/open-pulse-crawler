...
class TestCrawl:
    ...
    def test_bad_github_credentials_marks_job_failed(
        ...
        with patch.dict(os.environ, {"CRAWLER_GITHUB_TOKEN": "ghp_valid_format_token"}, clear=False):
            with patch("open_pulse_crawler.platforms.github.GitHubClient"):
...
class TestResume:
    ...
    def test_resume_dispatches_with_resume_flag(
        ...
        with patch.dict(
            ...
            with patch("open_pulse_crawler.platforms.github.GitHubClient"), patch(
    ...
    def test_resume_graphql_mode_uses_graphql_task(
        ...
        with patch.dict(
            ...
            with patch("open_pulse_crawler.platforms.github.GitHubGraphQLClient") as gql_cls, patch(
                "open_pulse_crawler.crawler.GitHubCrawler"
            ) as crawler_cls:
                crawler = crawler_cls.return_value
                crawler.current_round = 1
